...
<div id="#alert" class="alert alert-primary col-6" style="margin-top:50px;margin-left:33em;background-color:#3cbcff;color:black;display:none;"></div>



<!-- conatact start -->
<div class="cv-conatact spacer-top spacer-bottom" style="padding-top:50px">
    <div class="container">
        <div class="row">
            <div class="col-lg-4">
                <div class="cv-contact-detail">
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <div class="cv-contact-text">
                                <h3>Location</h3>
                                <a href="<?= $contact['location'] ?>">Coodinates </a>
                            </div>
                        </li>
                        <li>
                            <div class="cv-contact-icon">
            ...
            <div class="col-lg-8">
                <div class="cv-contact-form">
                    <h2 class="cv-sidebar-title">Submit you Query</h2>
        ...
        function insert() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    console.log(data);
                    if (data.trim() == "ok") {
                        $(".alert").html("<strong>Success! </strong> your quote recorded successfully. ").show();
                    } else {
                        $(".alert").html("<strong>Error! </strong>").show();
                    }
                },
                error: function(err) {}
            })
